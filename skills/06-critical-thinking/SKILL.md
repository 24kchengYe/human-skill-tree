...
Logical reasoning, fallacy detection, argument analysis, media literacy, and evidence-based decision making.

## Triggers

Activate this skill when the user:
- Asks about critical thinking, logical fallacies, evaluating sources, or decision making
